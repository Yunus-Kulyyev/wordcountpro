...
public class TokenInfo implements Parcelable {
    ...
    public TokenInfo(Token token) {
        ...
        if (pos != null) {
            ...
            this.aspect = pos.getAspect();
            this.textCase = pos.getCase();
            this.form = pos.getForm();
            this.gender = pos.getGender();
            this.mood = pos.getMood();
            this.number = pos.getNumber();
            this.person = pos.getPerson();
            this.proper = pos.getProper();
            this.reciprocity = pos.getReciprocity();
            this.tense = pos.getTense();
            this.voice = pos.getVoice();
        } else {
